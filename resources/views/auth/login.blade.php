    ...
    <div class="w-full max-w-md bg-white p-8 rounded-lg shadow-2xl border border-gray-300">
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div>
                ...
                <x-input id="email" class="block mt-1 w-full" type="email" placeholder="Ingresa tu Correo Registrado" name="email" :value="old('email')" required autofocus autocomplete="username" />
            </div>

            <div class="mt-4">
                <x-label for="password" value="{{ __('Contraseña') }}" />
                <x-input id="password" class="block mt-1 w-full" type="password" placeholder="Ingresa tu Corntraseña" name="password" required autocomplete="current-password" />
            </div>
